...
<simconf version="2022112801">
  <simulation>
    <title>rpl-ids 20 nodes, 20 m grid, dis, attackers=[9], seed 3, sliding, 30 min</title>
    ...
    <motetype>
      ...
      <commands>$(MAKE) -j$(CPUS) dis-attacker.cooja TARGET=cooja IDS_MODE=SLIDING IDS_WINDOW_SEC=300 IDS_LOG_EVENTS=0 ATTACK_START_SEC=75 ATTACK_DURATION_SEC=600 ATTACK_PERIOD_MS=30000</commands>
      <moteinterface>org.contikios.cooja.interfaces.Position</moteinterface>
      <moteinterface>org.contikios.cooja.interfaces.Battery</moteinterface>
      <moteinterface>org.contikios.cooja.contikimote.interfaces.ContikiVib</moteinterface>
      <moteinterface>org.contikios.cooja.contikimote.interfaces.ContikiMoteID</moteinterface>
